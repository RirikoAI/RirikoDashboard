...
import { Layout, Menu, Grid, Drawer, Button, theme, Divider } from "antd";
import {
  DashboardOutlined,
  LogoutOutlined,
...
export const ThemedSiderV2: React.FC<RefineThemedLayoutV2SiderProps> = ({
  ...
  const dashboard = hasDashboard ? (
    <Menu.Item key="dashboard"
               style={ {
                 // check if isSelected
                 backgroundColor: selectedKey === "/dashboard" ? token.controlItemBgActive : "",
               } }
  ...
  const renderSider = () => {
    ...
    return (
      <>
        ...
        <div role="presentation" className="ant-menu-item-group-title" title="Item 1">Other</div>
        <Menu.Item
          key="backToServerList"
          onClick={ () => {
            navigate("/");
          } }
          icon={ <BarsOutlined/> }
        >
          { translate("buttons.backToServerList", "Server List") }
        </Menu.Item>
        { logout }
      </>
    );
